...
class _RegisterState extends State<Register> {
  ...
  File? file;
  var options = ['Student', 'Teacher', 'Parents'];
  ...
  void signUp(
    ...
    if (_formkey.currentState!.validate()) {
      await _auth
          ...
          .then((value) => {postDetailsToFirestore(username, email, rool)})
          .catchError((e) {
  ...
  postDetailsToFirestore(String username, String email, String rool) async {
